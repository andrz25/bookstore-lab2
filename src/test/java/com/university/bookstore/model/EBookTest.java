...
/**
 * Detailed test suite for the EBook class.
 * Tests creation, validation, discount calculation, and reading time
 * estimation.
 */
class EBookTest {
    ...
    void testEBookValidation() {
        ...
        // Test null author
        assertThrows(NullPointerException.class, () -> new EBook("978-0134685991", "Test Book", null,
                45.99, 2018, "PDF", 2.5, false, 50000, MediaQuality.HIGH));

        // Test null quality
        assertThrows(NullPointerException.class, () -> new EBook("978-0134685991", "Test Book", "Test Author",
    ...
    void performanceComparison() {
        ...
        // Simple ArrayList-based storage for performance testing
        java.util.List<EBook> arrayList = new java.util.ArrayList<>();
        ...
        EBook foundArray = arrayList.stream()
                .filter(ebook -> "ID-5000".equals(ebook.getId()))
                .findFirst()
                .orElse(null);
        ...
        java.util.Map<String, EBook> hashMap = new java.util.HashMap<>();
        startTime = System.nanoTime();
        for (int i = 0; i < 10000; i++) {
            EBook eBook = new EBook(
                    "ID-" + i,
                    ...
                    50000,
                    MediaQuality.HIGH);
            hashMap.put(eBook.getId(), eBook);
        }
        long addHashTime = System.nanoTime() - startTime;

        startTime = System.nanoTime();
        EBook foundHash = hashMap.get("ID-5000");
